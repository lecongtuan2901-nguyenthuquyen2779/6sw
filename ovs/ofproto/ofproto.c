    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    *ofprotop = NULL;
    ...
    FILE *fp;
    fp = fopen("home/lctuan/result_LoOP/dpid.log","a+");
      fprintf(fp, "%ld,%d\n",ofproto->datapath_id,co_unt);
      fclose(fp);
...
void abnormal_detect1(struct ofproto *p)
{
    ...
    float current_traf1,current_flow1;
  


    long now_recorded_n_flow1;
    long now_recorded_n_bytes1;
    ...
    {  
      ...
      now_recorded_n_flow1=get_packet_in_counter();
      // fp1=fopen("home/lctuan/result_LoOP/byte.log","a+");
      // fprintf(fp1, "%ld,%f,%f\n",now_recorded_n_bytes1,(float)now_recorded_n_bytes1,p->last_recorded_n_bytes1);
      // fclose(fp1);
      ...
      if(p->training1==1)
     {    
        if(p->data_counter1==0 || p->data_counter1 == DATATOTAL)
          fp1=fopen("/home/lctuan/result_LoOP/training1.log","r");  //read only for read in calculate
        ...
        if (p->data_counter1 < DATATOTAL && p->writing1 ==1)
        {
          p->writing1=1;
        ...
        { 
          ...
          while(p->data_counter1<DATATOTAL)
          //for (int i=0;i<DATANUM;i++)
          {
          ...
          float temp1;
          // fp1= fopen("/home/lctuan/result_LoOP/debug1.log","a+");
          for(int i=0;i<p->data_counter1;i++)
          {
           p->Data1[i].LoOP = LoOP(&p->Data1[i],p->Data1);

            fp1=fopen("/home/lctuan/result_LoOP/arr1.log","a+");
            fprintf(fp1,"%d, %f, %f, ",p->Data1[i].id, p->Data1[i].PLOF, p->Data1[i].LoOP);  //0, 0
            for (int j =0 ; j< DATATOTAL - 1; j++)
              fprintf(fp1,"%f,  ", p->Data1[i].neighbor[j].distance);
            fprintf(fp1,"\n");
            fclose(fp1); 
          ...
          // fp1=fopen("/home/lctuan/result_LoOP/time1.log","a+");
      ...
      else 
      {
         ...
         p->loOP_status1 = LoOP_udate(p->state1,p->Data1);
          ...
          fp1= fopen("/home/lctuan/result_LoOP/debug1.log1","a+");
          fprintf(fp1,"%f,%f,%f,%f\n",p->state1->traffic_norm,p->state1->n_flow_norm,p->loOP_status1,p->loOP_threshold1);
          fclose(fp1);
          }
      }
      // fp1=fopen("/home/lctuan/result_LoOP/count3.log","a+");
      //     fprintf(fp1, "%d, %d, %d,%d\n",p->data_counter1,p->writing1,p->training1,p->count_1);
      //     fclose(fp1);
      p->last_recorded_n_bytes1=now_recorded_n_bytes1;
...
//     float current_traf2,current_flow2;
 


//     long now_recorded_n_flow2;
//     long now_recorded_n_bytes2;
...
//       fp2=fopen("home/lctuan/result_LoOP/data_recording2.log","a+");
...
//           fp2=fopen("/home/lctuan/result_LoOP/training2.log","r");
//         /*check training file exist or not .if not exist or not enough data, recording.
//           if exists , move to calculating*/
...
//           float temp2;
//           fp2= fopen("/home/lctuan/result_LoOP/debug2.log","a+");
//           for(int i=0;i<p->data_counter2;i++)
//           {
...
//           fp2=fopen("/home/lctuan/result_LoOP/time2.log","a+");
//           fprintf(fp2,"%lu\n",(end2.tv_sec - start2.tv_sec)*1000000+end2.tv_usec-start2.tv_usec);
//           fclose(fp2);
//           fp2=fopen("/home/lctuan/result_LoOP/nor_training2.log","a+");
//           for(int i=0;i<p->data_counter2;i++)
//           {
...
//           fp2= fopen("/home/lctuan/result_LoOP/debug2.log1","a+");
//           fprintf(fp2,"%f,%f,%f,%f\n",p->state2->traffic_norm,p->state2->n_flow_norm,p->loOP_status2,p->loOP_threshold2);
//           fclose(fp2);
//           }
//       }

//       p->last_recorded_n_bytes2=now_recorded_n_bytes2;
...
//     float current_traf3,current_flow3;
//     //int count;


//     long now_recorded_n_flow3;
//     long now_recorded_n_bytes3;
...
//           fp3=fopen("/home/lctuan/result_LoOP/training3.log","r");
//         /*check training file exist or not .if not exist or not enough data, recording.
//           if exists , move to calculating*/
...
//           float temp3;
//           fp3= fopen("/home/lctuan/result_LoOP/debug3.log","a+");
//           for(int i=0;i<p->data_counter3;i++)
//           {
//            // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
...
//           fp3=fopen("/home/lctuan/result_LoOP/time3.log","a+");
//           fprintf(fp3,"%lu\n",(end3.tv_sec - start3.tv_sec)*1000000+end3.tv_usec-start3.tv_usec);
//           fclose(fp3);
//           fp3=fopen("/home/lctuan/result_LoOP/nor_training3.log","a+");
//           for(int i=0;i<p->data_counter3;i++)
//           {
...
//           fp3= fopen("/home/lctuan/result_LoOP/debug3.log1","a+");
//           fprintf(fp3,"%f,%f,%f,%f\n",p->state3->traffic_norm,p->state3->n_flow_norm,p->loOP_status3,p->loOP_threshold3);
//           fclose(fp3);
//           }
//       }
...
//     float current_traf4,current_flow4;



//     long now_recorded_n_flow4;
//     long now_recorded_n_bytes4;
...
//       fp4=fopen("home/lctuan/result_LoOP/data_recording4.log","a+");
...
//           fp4=fopen("/home/lctuan/result_LoOP/training4.log","r");
//         /*check training file exist or not .if not exist or not enough data, recording.
//           if exists , move to calculating*/
...
//           float temp4;
//           fp4= fopen("/home/lctuan/result_LoOP/debug4.log","a+");
//           for(int i=0;i<p->data_counter4;i++)
//           {
//            // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
...
//           fp4=fopen("/home/lctuan/result_LoOP/time4.log","a+");
//           fprintf(fp4,"%lu\n",(end4.tv_sec - start4.tv_sec)*1000000+end4.tv_usec-start4.tv_usec);
//           fclose(fp4);
//           fp4=fopen("/home/lctuan/result_LoOP/nor_training4.log","a+");
//           for(int i=0;i<p->data_counter4;i++)
//           {
...
//           fp4= fopen("/home/lctuan/result_LoOP/debug4.log1","a+");
//           fprintf(fp4,"%f,%f,%f,%f\n",p->state4->traffic_norm,p->state4->n_flow_norm,p->loOP_status4,p->loOP_threshold4);
//           fclose(fp4);
//           }

//       }

//       p->last_recorded_n_bytes4=now_recorded_n_bytes4;
...
//     float current_traf5,current_flow5;



//     long now_recorded_n_flow5;
//     long now_recorded_n_bytes5;
...
//       fp5=fopen("home/lctuan/result_LoOP/data_recording5.log","a+");
...
//           fp5=fopen("/home/lctuan/result_LoOP/training5.log","r");
//         /*check training file exist or not .if not exist or not enough data, recording.
//           if exists , move to calculating*/
...
//           float temp5;
//           fp5= fopen("/home/lctuan/result_LoOP/debug5.log","a+");
//           for(int i=0;i<p->data_counter5;i++)
//           {
//            // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
...
//           fp5=fopen("/home/lctuan/result_LoOP/time5.log","a+");
//           fprintf(fp5,"%lu\n",(end5.tv_sec - start5.tv_sec)*1000000+end5.tv_usec-start5.tv_usec);
//           fclose(fp5);
//           fp5=fopen("/home/lctuan/result_LoOP/nor_training5.log","a+");
//           for(int i=0;i<p->data_counter5;i++)
//           {
...
//           fp5= fopen("/home/lctuan/result_LoOP/debug5.log1","a+");
//           fprintf(fp5,"%f,%f,%f,%f\n",p->state5->traffic_norm,p->state5->n_flow_norm,p->loOP_status5,p->loOP_threshold5);
//           fclose(fp5);
//           }
//       }

//       p->last_recorded_n_bytes5=now_recorded_n_bytes5;
...
//     float current_traf6,current_flow6;



//     long now_recorded_n_flow6;
//     long now_recorded_n_bytes6;
...
//       fp6=fopen("home/lctuan/result_LoOP/data_recording6.log","a+");
...
//           fp6=fopen("/home/lctuan/result_LoOP/training6.log","r");
//         /*check training file exist or not .if not exist or not enough data, recording.
//           if exists , move to calculating*/
...
//           float temp6;
//           fp6= fopen("/home/lctuan/result_LoOP/debug6.log","a+");
//           for(int i=0;i<p->data_counter6;i++)
//           {
//            // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
...
//           fp6=fopen("/home/lctuan/result_LoOP/time6.log","a+");
//           fprintf(fp6,"%lu\n",(end6.tv_sec - start6.tv_sec)*1000000+end6.tv_usec-start6.tv_usec);
//           fclose(fp6);
//           fp6=fopen("/home/lctuan/result_LoOP/nor_training6.log","a+");
//           for(int i=0;i<p->data_counter6;i++)
//           {
...
//           fp6= fopen("/home/lctuan/result_LoOP/debug6.log1","a+");
//           fprintf(fp6,"%f,%f,%f,%f\n",p->state6->traffic_norm,p->state6->n_flow_norm,p->loOP_status6,p->loOP_threshold6);
//           fclose(fp6);
//           }

//       }

//       p->last_recorded_n_bytes6=now_recorded_n_bytes6;
...
ofproto_run(struct ofproto *p)
{
    ...
    // FILE *f;
    // f=fopen("home/lctuan/result_LoOP/check_dpid.log","a+");
    //   fprintf(f, "%ld\n",p->datapath_id);
    //   fclose(f);

    // switch (p->datapath_id)
    // {
