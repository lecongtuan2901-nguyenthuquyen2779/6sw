...
struct ofproto {
    ...
    float traffic_arr1[DATATOTAL];  /*array store the traffic data for calculating lof*/
    float flow_arr1[DATATOTAL];     /*array store the flow data for calculating lof*/
    
    data_t *state1;  /*status of current (traffic,new flow)*/
    data_t Data1[DATATOTAL]; /*store the LoOP of all training data*/
    long last_time1;
    int data_counter1;
   // float lof_status;
   float loOP_status1;
